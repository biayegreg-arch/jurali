    ...
    <div className="flex-1 flex flex-col min-w-0">
      <div className="flex items-center gap-3 px-4 lg:px-8 pt-6 lg:pt-8 pb-5 border-b border-border">
        ...
        <div>
          ...
          <div className="text-sm text-muted-foreground mt-0.5">Choisis ton moyen de paiement</div>
        </div>
      </div>
      ...
      <div className="px-4 lg:px-8 py-6 lg:py-8 flex flex-col lg:flex-row gap-6 lg:gap-8">
        ...
        <div className="flex-1 flex flex-col gap-5 min-w-0">
          <div className="bg-background border border-border rounded-xl p-5">
            ...
            <div className="font-headings font-bold text-3xl text-primary">
              ...
              <span className="text-sm font-body font-normal text-muted-foreground">FCFA/mois</span>
            </div>
          </div>
                ...
                >
                  ...
                  >
                    <Icon
                      ...
                      size={18}
                      className={
                        method === m.value ? 'text-secondary-foreground' : 'text-muted-foreground'
                      }
                    />
                  </div>
                  <div className="flex-1">
                    <div className="font-headings font-bold text-sm text-foreground">{m.label}</div>
          ...
          <div className="bg-background border border-border rounded-xl p-5">
            <div className="font-headings font-bold text-base text-foreground mb-1">Code promo</div>
        ...
        <div className="flex flex-col gap-5 lg:w-[340px] lg:flex-shrink-0">
          ...
          <div className="flex items-start gap-3 px-4 py-3 bg-input rounded-lg">
            ...
            <div className="text-xs text-muted-foreground">
              Résiliation possible à tout moment depuis la Gestion Premium. Aucun engagement à long
              terme.
            </div>
          </div>
        </div>
